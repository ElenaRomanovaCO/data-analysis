...
def main():
    ...
    dataset_name = "forecasting_taco_sales"
    train_csv_filepath = "data_science/utils/data/train_taco_sales_2024-2025.csv"
    test_csv_filepath = "data_science/utils/data/test_taco_sales_2024-2025.csv"
